...
export const ServiceDetail = ({ serviceId }) => {
    const data = serviceDetailData[serviceId] || serviceDetailData['website-development'];
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-1/2 relative min-h-[400px] lg:min-h-[500px] flex items-center justify-center lg:block">
                        ...
                        {/* Adjusted position for mobile to avoid covering main content too much or looking weird */}
